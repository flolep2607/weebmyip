...
const ip2sound=(ip,res)=>{
	...
	console.log(typeof fs.statSync(FILE_path).mtime,fs.statSync(FILE_path).mtime,fs.statSync(FILE_path).mtime.getTime(),Date.getTime(),Date.getTime()-fs.statSync(FILE_path).mtime.getTime())
